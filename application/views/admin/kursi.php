<html>
	<link rel="stylesheet" type="text/css" href="../inc/metro-ui/css/metro-bootstrap.css">
    
<head>
	<title>Cetak Buku Wisuda</title>
<head>
<body class="metro" bgcolor='#191970'>	
<?php
...
?>
	...
	<br>
	<br>
	<div id="menu" style="background-color:#FFD700;height:500px;width:1000px;float:left;position:absolute;margin-top:15px;margin-left:130px;">
<?php echo form_open(base_url().'kursiwisuda/pengaturan_kursi'); ?>   
	<br><br>           
	<table border='0'>
		<tr>
			<td bgcolor='#FFD700' width='60%' align='center'><img src='../inc/logo_ITS.jpg' width='90%' height='60%'></td>
			<td bgcolor='#FFD700'>
			...
			?>
				...
				<input type='text' name='jmlhari'  value=<?PHP echo $selisih;?>><br>
				<h3>Jumlah Baris</h3>
