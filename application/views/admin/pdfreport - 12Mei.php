<?PHP
	...
	$pdf->SetDefaultMonospacedFont('calibrilighti');
			...
			foreach ($data_prodi as $key => $value) 
				{
					...
					$data_tgl_kelulusan = $this->Db_kursi->fakultas_jurusan_program($periodewisuda);
					...
					$html=$html.'
							...
							<br>&nbsp;
									<h3 align="center">
										...
										WISUDA KE '.$periodewisuda.', '.date("d-m-Y",strtotime($tanggal)).'
									</h3>
									...
									<table align="center" >
											<tr>
												...
												<td style="width:35mm" class="atas"></td>
											...
											<tr>
												...
												<td style="width:35mm"><br/>JURUSAN</td>
												<td style="width:11mm"><br/>DERET</td>
												<td style="width:10mm"></td>		
												<td style="width:11mm">KURSI</td>																							
												<td style="width:6%">URUT</td>
												<td style="width:22mm">NRP</td>
												<td style="width:35%"><br>N A M A </td>	
												<td style="width:10mm">CEK1</td>
												<td style="width:10mm">CEK2</td>
											</tr>
											<tr>
					...
					for ($j=1; $j<=$ctr; $j++)
					{
						...
						{	
							...
							$html=$html.'					
								<tr>
									<td style="width:5mm"></td>
									<td colspan="8" align="center"><b>'.strtoupper($namafakultas[$j]). '</b></td>
									<td style="width:5mm"></td>
								</tr>';
						...
						{	$no=0;
							...
							$html=$html.'					
								<tr>
									<td style="width:5mm"></td>
									<td colspan="8" align="center"><br><b>'.strtoupper($namajurusan[$j]). '</b></td>
									<td style="width:5mm"></td>
								</tr>';
							$jumlah=$jumlah+1;
							...
							<tr>
								<td style="width:7mm">'.$no.'</td>
								<td style="width:35mm">'.$namajurusan[$j].'</td>
								<td style="width:11mm">'.$kodekursi.'</td>';
							...
							$html=$html.'<td style="width:6%">'.$urut.'</td>
										...
										<td style="width:35%" align="left"> '.strtoupper($namatbl[$j]).'</td>
							';			
							if($predikat[$j]=='DP'){
								$html=$html.'
								...
								<td style="width:10mm"></td>
									...
									$cekbaris=$ctrbaris+($cekbidangkeahlian*2);
				...
				<table border='1' style=\"border:1px solid red;\" width='100%'>
					<tr>
						<td style=\"width:'100%'; height:'".$tinggi.".mm'; border:3px solid blue;\">
							<br><br>
							<h3 align=\"center\">
							<img src=\"/cobakursi/inc/logo.jpg\" style=\"width: 50; height: 50\" />
									DENAH TEMPAT DUDUK WISUDAWAN KE ".$periodewisuda."<br>
									INSTITUT TEKNOLOGI SEPULUH NOPEMBER<br>
									Program DOkter, Magister, Sarjana, dan Poloteknik<br>
									Tanggal Wisuda : ".date("D, d-m-Y",strtotime($tanggal)).", PUKUL 07. 00 s.d selesai<br>
								</h3>
							<table>
							<tr>
