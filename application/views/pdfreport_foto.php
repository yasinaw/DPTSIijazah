	...
	foreach ($data_prodi as $key => $value) 
		{
				...
				<tr>					
					<td width=\"100%\" style=\"border:2px solid pink ; height:50mm\">
						...
						<tr>
							...
							<td style=\"width:'94%'; height:'".($tinggi-30).".mm'; border:2px solid blue\">
							<table  width='100%'>
								<tr>
									<td style=\"width:'100%'; height:'".($tinggi-35).".mm'; border:2px solid red\">";	
			...
			/*$html=$html.'</td></tr>
						...
						<tr>
							...
							<td width="45%" style="border:2px solid black" align="right"></td>
							<td align="center" width="1.5cm" border-bottom="1" style=\"border-radius: 10px;\">
								<!--img src="/simwisuda/inc/kiri_atas.png" style="width: 15; height: 15" /-->
								'.$halaman.'
								<!--img src="/simwisuda/inc/kanan_atas.png" style="width: 15; height: 15" /-->																
							</td>
							<td width="45%"></td>
						...
						<tr>
							<td width="25%"></td>
							<td align="center" width="50%" background="/simwisuda/inc/img/no-images.jpg"><b>Wisuda ke-'.$periodewisuda.' ITS</b></td>
							<td width="25%"></td>
						</tr>
					</table>
					</td>
					...
					<!--br><img src="/simwisuda/inc/bawah.png" style="width: 1500; height: 30"-->
				</tr>
				<!--tr>
					<td><img src="/simwisuda/inc/bawah.png" style="width: 1500; height: 30"></td>
				</tr--><img src="/simwisuda/inc/bawah.png" style="width: 1500; height: 50">
				</table>
			</td>
		</tr>
		<!--img src="/simwisuda/inc/bawah.png" style="width: 2200; height: 30"-->
		</table>
			...
			<table style=\"height:'".($tinggi-50).".mm'\"  width='100%'>	
				...
				<tr>
					...
					$html=$html."
						...
						<tr>
							...
							<td style=\"width:100%; height:'".($tinggi-10).".mm'\">
								...
								<tr>
									<!--td style=\"width:3%\"></td-->
									<td style=\"width:'100%'; border:2px solid black;height:'".($tinggi-25).".mm'\">"; 
					...
					if (($ukurankertas=='ITS PAPER') || ($ukurankertas=='B5'))
						...
						{		
							$html=$html.'<td style="width: 50%; height:180mm; border:2px solid red">';
							//$html=$html.'<td style="width: 50%; border:3px solid pink">';
						}
