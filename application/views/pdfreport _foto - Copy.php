	...
	foreach ($data_prodi as $key => $value) 
		{
			...
			<table style=\"height:'".($tinggi-50).".mm'\"  width='100%'>	
				<tr>
					<td>
						<img src=\"/simwisuda/inc/atas.png\" style=\"width: '1500'; height: 30\" >
					</td>
				</tr>
				<tr>
					<td valign=\"middle\" width=\"2%\">
						<!-- GAMBAR BORDER KIRI -->
						<br>
						<img src=\"/simwisuda/inc/side.png\" style=\"width: 30; height: 800\" >
					</td>
					<td width=\"96%\">
						<table>
						<tr>
							<td style=\"width:'98%'; height:'".($tinggi-20).".mm'\">
							<table border='0'  width='100%'>
								<tr>
									<td style=\"width:'100%'; height:'".($tinggi-$marginbottom-30).".mm'\">";		
			...
			{ 
				...
				<tr>
					<td style="width:1%"></td>
					<td class="bawah"></td>
					<td class="bawah" align="left"  colspan="2">IP / Lama Studi Rata-Rata LJ</td>
					<td class="bawah">'.number_format($iprata2lj,2).'</td>
					<td class="bawah">'.number_format($lamastudirata2lj,2).'</td>
			...
			<table style=\"height:'".($tinggi-50).".mm'\"  width='100%'>	
				...
				<tr>
					<td valign=\"middle\" width=\"2%\">
						...
						<img src=\"/simwisuda/inc/side.png\" style=\"width: 30; height: 800\" ><br>
						<img src=\"/simwisuda/inc/side.png\" style=\"width: 30; height: 800\" ><br>
						<img src=\"/simwisuda/inc/side.png\" style=\"width: 30; height: 561\" >
					</td>
					<td width=\"96%\">
			...
			<table>
				<tr>	
					<td style=\"border:5px solid black; height:200mm\">	
						<table width=\"110%\" > 
						<tr>
							<td style=\"border:3px solid green; width=150%\" colspan=\"4\">
								<img src=\"/simwisuda/inc/atas.png\" style=\"width: '2900'; height: 80\">
							</td>
						</tr>
						<tr>
							<td valign=\"middle\" width=\"2%\" style=\"border:2px solid pink;\">
								<!-- GAMBAR BORDER KIRI -->
								<br>
								<img src=\"/simwisuda/inc/side.png\" style=\"width: 30; height: 2200\">&nbsp; 								
							</td>
							<td style=\"width:92%; height:180mm; border:5px solid yellow\">
								<!-- table green-->		
								<!--table width='100%' style=\"border:3px solid green\"-->
								<table width=\"100%\">
								<tr>
									<!--td style=\"width:3%\"></td-->
									<td style=\"width:'100%'; height:172mm; border:5px solid green\">"; 
					/*Border layout kolom kiri kanan*/
					$html=$html.'<table style="width: 100%;height:'.($tinggi-$marginbottom-30).'mm">
							<tr >';
					...
					if (($ukurankertas=='ITS PAPER') || ($ukurankertas=='B5')){		
						...
						{		
							$html=$html.'<td style="width: 50%; height:170mm">';
							//$html=$html.'<td style="width: 50%; border:3px solid pink">';
						}
					...
					<table>
						<tr>
							<td style="height:62mm; border:1px solid green">
								<table width="98%">
									<tr>
										<td width="2.2cm">';							
					...
					if (($ukurankertas=='ITS PAPER') || ($ukurankertas=='B5'))
						...
						{		
							$html=$html.'<td style="width: 5mm;border:1px solid red"></td><td style="width: 50%; height:170mm">';
							//$html=$html.'<td style="width: 50%; border:3px solid pink">';
						}
					...
					for ($i=(($jumdata-$jumkolom)+1); $i<=$jumdata; $i++)
					{
						...
						<table>
							<tr>
								<td style="height:62mm; border:2px solid blue">
								<table width="100%">
									<tr>
										<td width="2.2cm">';
					...
					<table width="100%">
						<tr>
							...
							<tr>								
								<td align="center" colspan="3" style="border:2px solid blue">
					...
					<td width="4%"></td>
					<td width="2%" style="border:2px solid black">					
						<br>
						<img src="/simwisuda/inc/side.png" style="width: 30; height: 1100" ></td>
					</tr>
					<tr>
						<td style="border:2px solid orange" colspan="4">
						<!-- border bawah -->
							<img src="/simwisuda/inc/bawah.png" style="width: 3500; height: 100">			
						</td>						
					</tr>
					</table><!-- tabel red-->
				</td>
