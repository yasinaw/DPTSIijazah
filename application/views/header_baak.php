        ...
        <ul class="element-menu">
			<li>
				...
				<ul class="dropdown-menu " data-role="dropdown">
					<li><a href="<?php echo base_url().'buku/';?>">Generate Buku Wisuda</a></li>
					<li><a href="<?php echo base_url().'buku/data_buku';?>">Data Buku Wisuda</a></li>
					<li><a href="<?php echo base_url().'buku/master_lulusan_ke';?>">Data Lulusan Ke</a></li>					
					
					<li class="divider"></li>
					<li><a href="<?php echo base_url().'buku/upload_buku';?>">Upload Buku Wisuda</a></li>
				</ul>
			</li>           
        </ul>
